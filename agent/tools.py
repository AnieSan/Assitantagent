from assitantagent.rag.RagSummarizeService import RagSummarizeService
from langchain_core.tools import tool
import random
from assitantagent.utils.logger import logger
from assitantagent.utils.config_loader import agent_cfg
...
@tool(description="获取用户的城市,以消息字符串的形式返回")
def get_city():
    return random.choice(["广州","深圳","佛山"])
